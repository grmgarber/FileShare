...
class UploadsController < ApplicationController
  ...
  # viewers of the current upload.
  # jQuery UI passes a :term parameter with N letters typed into the
  # autocomplete field
  def potential_grantees
    render json: User.potential_grantee_emails(current_user.id, params[:id],
                                               term: params['term'])
  end
